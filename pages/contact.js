    ...
    <div className={styles.contact}>
      <div className={styles.contact_greeting }>
        ...
        <p className={styles.contact_greeting__text}>
          ...
          reservations. If no one is available to take your call, please
          leave a message. We will contact you as soon as possible.
        </p>
      </div>
      ...
      <div className={styles.contact__details}>
          ...
          <p className={styles.contact__details_info}>355 E 5TH ST, MANHATTAN, NY 10003</p>
      ...
      <Image width={210} height={140} layout="responsive" src="/assets/images/contact_01.png" alt="Google map" />
      </div>
    </div>
  );
};
